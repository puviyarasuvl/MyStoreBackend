...
describe('Testing Customer Dashboard', function () {
    describe('currentOrder method', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, orderModel.addProduct(2, 1, 'testUser2')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, orderModel.addProduct(3, 2, 'testUser2')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('expect no of orders to be 1', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderModel.index('testUser2')];
                    case 1:
                        result = _a.sent();
        ...
        it('close the order id 3 for testUser2', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderModel.update(3, 'placed')];
                    case 1:
                        result = _a.sent();
        ...
        it('should throw msg when cart is empty', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, customerDashboard.currentOrder('testUser2')];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    describe('completedOrders method', function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        expectedCompletedOrders.orders[1].createdDate =
                            new Date().toLocaleString();
                        return [4 /*yield*/, orderModel.addProduct(2, 10, 'testUser2')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, orderModel.addProduct(3, 20, 'testUser2')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('expect no of orders to be 2', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderModel.index('testUser2')];
        ...
        it('close the order id 3 for testUser2', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderModel.update(4, 'placed')];
                    case 1:
                        result = _a.sent();
                        expect(result.status).toEqual('placed');
                        return [2 /*return*/];
