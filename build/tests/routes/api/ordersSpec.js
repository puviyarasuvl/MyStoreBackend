...
describe('Testing orders route', function () {
    it('[get] /api/orders should return all the orders information', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res, response;
    ...
    it('[post] /api/orders/addProduct should allow user to add products to the cart (open order)', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('[get] /api/orders/2 should return specified order details to the user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request
    ...
    it('[patch] /api/orders should allow user to update the status', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request
