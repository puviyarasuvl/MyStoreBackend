...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, productModel.create(newProduct)];
            case 2:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 4];
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.show(parseInt(req.params.productId))];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
...
var productsByCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.productsByCategory(req.params.category)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
